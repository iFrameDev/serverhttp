...
var bank = require('./Banque/Data_Bank');
...
app.listen(3000,"25.67.36.28", async function() {
...
app.use('/', require('./Banque/Data_Bank'))
app.use('/', require('./Characters_Stats/RW_Characters_Stats'))
